...
<form action="{{ route('capsule-post.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded p-6">
    ...
    <div class="mb-4">
        ...
        <select name="capsule_type" id="capsule_type" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
    ...
    <div class="mb-4">
        ...
        <input type="datetime-local" name="future_time" id="future_time" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
    </div>
