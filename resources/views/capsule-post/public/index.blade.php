                ...
                <div class="bg-white" x-data="publicCapsuleManager()">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-4 border shadow-md">
                            ...
                            <div class="relative">
                                <input type="text" x-model="searchQuery" @input.debounce.300ms="filterCapsules()"
                                                    ...
                                                    <div class="treasure-chest animate-bounce">
                                                        <svg class="w-32 h-32" viewBox="0 0 24 24" fill="none">
                                                            ...
                                                            <rect x="7" y="12" width="10" height="2"
                                                                fill="gold" class="animate-pulse" />
                                                        </svg>
                                                    </div>
                                                    <div class="absolute bottom-4 text-white text-center">
                                                        <p class="font-medium">Locked until</p>
                                                        <p class="text-lg">
                                                            {{ $capsule->future_time->format('M d, Y H:i') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        @else
                                            <img src="{{ asset('storage/' . $capsule->image) }}"
                                                alt="{{ $capsule->title }}" class="w-full h-48 object-cover">
                                        @endif
                                    </div>
