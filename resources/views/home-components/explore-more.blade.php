        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div class="relative pl-16">
                    ...
                    <dd class="mt-2 text-base/7 text-gray-600">Store and organize your cherished memories effortlessly. Securely upload photos or documents to keep
                ...
                <div class="relative pl-16">
                    ...
                    <dd class="mt-2 text-base/7 text-gray-600">Use encryption to store sensitive data such as passwords
                        or other personal information using bcrypt, which is
                        considered secure.</dd>
                {{-- </div>
                <div class="relative pl-16">
                    <dt class="text-base/7 font-semibold text-gray-900">
                        <div
                    ...
                    <dd class="mt-2 text-base/7 text-gray-600">Quisque est vel vulputate cursus. Risus proin diam nunc
                ...
                <div class="relative pl-16">
                    ...
                    <dd class="mt-2 text-base/7 text-gray-600">Arcu egestas dolor vel iaculis in ipsum mauris. Tincidunt
                        mattis aliquet hac quis. Id hac maecenas ac donec pharetra eget.</dd>
                </div> --}}
            </dl>
        </div>
    </div>
