<div class="bg-white relative h-screen lg:h-auto max-h-screen">
    <div class="relative isolate px-6 pt-14 lg:px-8 h-full">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-44 h-full flex flex-col justify-center items-center">
            <div class="flex justify-center">
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Preserve Your Moments
                        for
                        the Future</h1>
