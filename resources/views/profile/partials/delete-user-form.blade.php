<section class="space-y-6 w-full">
    ...
    <x-danger-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')"
        class="flex items-center space-x-2 hover:bg-red-600 transition-colors duration-200">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6 relative" x-data="{ showPassword: false }">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <x-text-input id="password" name="password" x-bind:type="showPassword ? 'text' : 'password'"
                        class="pl-10 pr-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500"
