<style>
    ...
    .nav-link:hover {
        @apply text-indigo-600 border-indigo-400;
    }

    .nav-link:focus {
        @apply outline-none text-indigo-700 border-indigo-500;
    }
    ...
    .responsive-nav-link:hover {
        @apply text-indigo-600 bg-indigo-50 border-indigo-400;
    }

    .responsive-nav-link:focus {
        @apply outline-none text-indigo-700 bg-indigo-100 border-indigo-500;
    }
    ...
    .dropdown-link:focus {
        @apply outline-none bg-indigo-100 text-indigo-700;
    }
</style>
...
<nav x-data="{ open: false }" class="bg-white shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('capsules.index')" :active="request()->routeIs('capsules.index')" class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <x-nav-link :href="route('capsules.public.index')" :active="request()->routeIs('capsules.public.*')">
                    ...
                    <x-nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')" class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-600 bg-white hover:text-indigo-600 focus:outline-none focus:text-indigo-600 transition ease-in-out duration-150">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('capsules.index')" :active="request()->routeIs('capsules.index')" class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            ...
            <x-responsive-nav-link :href="route('capsules.public.index')" :active="request()->routeIs('capsules.public.*')" class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
